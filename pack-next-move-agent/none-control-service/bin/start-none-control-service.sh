...
. "${NEXT_MOVE_SERVICE_HOME}/bin/none-control-service-env.sh"

echo "Starting None-Control service..."
...
>${NEXT_MOVE_SERVICE_LOG}/stdout.log 2>${NEXT_MOVE_SERVICE_LOG}/stderr.log &echo $!>${NEXT_MOVE_SERVICE_HOME}/pid/none-control-service.txt
